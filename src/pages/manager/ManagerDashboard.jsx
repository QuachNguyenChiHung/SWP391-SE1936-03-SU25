...
import { Layers, CheckCircle2, FileText, Users, Plus, AlertCircle } from 'lucide-react';
...
export const ManagerDashboard = ({ user }) => {
    ...
    const stats = [
        { label: 'Active Projects', value: totalProjects, icon: Layers, color: 'text-blue-600', bg: 'bg-blue-50' },
        { label: 'Global Completion', value: `${overallProgress}%`, icon: CheckCircle2, color: 'text-green-600', bg: 'bg-green-50' },
        { label: 'Total Tasks', value: totalTasks.toLocaleString(), icon: FileText, color: 'text-indigo-600', bg: 'bg-indigo-50' },
        { label: 'Team Members', value: MOCK_USERS.length, icon: Users, color: 'text-orange-600', bg: 'bg-orange-50' },
    ];
        ...
        <div className="h-100 d-flex flex-column gap-4 animate-in fade-in duration-300">
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                ...
                <div className="text-end d-none d-md-block">
                    ...
                    <span className="badge bg-indigo-light text-indigo rounded-pill">
                        {user.role}
                    </span>
                </div>
            </div>
