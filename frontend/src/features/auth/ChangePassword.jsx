...
export const ChangePassword = () => {
    ...
    const headerTitle = token ? 'Reset Your Password' : 'Secure Your Account';
    const subtitle = token ? 'Create a new password using the link provided.' : `Create a new strong password for ${email || 'Unknown User'}`;
            ...
            <div className="card border-0 shadow-lg rounded-4 overflow-hidden" style={{ maxWidth: 480, width: '100%' }}>
                <div className="card-body p-5">
                    ...
                    <div className="text-center mb-4">
                        ...
                        <h3 className="fw-bold text-dark">{headerTitle}</h3>
                    ...
                    <form onSubmit={handleChange}>
                        ...
                        <div className="d-grid gap-2">
                            <button className="btn btn-primary btn-lg fw-semibold" type="submit" disabled={isLoading || (!email && !token)}>
                                {isLoading ? (
                    ...
                    <div className="text-center mt-4 pt-2 border-top">
                        <button type="button" onClick={() => navigate('/login')} className="btn btn-link text-decoration-none text-muted d-inline-flex align-items-center gap-2" style={{ fontSize: '0.9rem' }}>
